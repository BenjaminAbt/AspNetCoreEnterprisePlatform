...
public class GetAzureLogAnalyticsAzureSignInLocationStatsQueryHandler : IQueryHandler<GetAzureSignInLocationStatsQuery, ResultSeries<AzureSignInLocationStats>?>
{
    private readonly ILogger<GetAzureLogAnalyticsAzureSignInLocationStatsQueryHandler> _logger;
    private readonly IEventDispatcher _eventDispatcher;
    private readonly AzureLogAnalyticsDataProvider _logAnalyticsRepository;

    public GetAzureLogAnalyticsAzureSignInLocationStatsQueryHandler(
        ILogger<GetAzureLogAnalyticsAzureSignInLocationStatsQueryHandler> logger,
    ...
    public async Task<ResultSeries<AzureSignInLocationStats>?> Handle(GetAzureSignInLocationStatsQuery request, CancellationToken cancellationToken)
    {
        // prepare
        ...
        // execute
        ResultSeries<AzureSignInLocationStats> stats
            = await _logAnalyticsRepository.GetAzureSignInLocationStatsSeries(workspaceId, from, to);
