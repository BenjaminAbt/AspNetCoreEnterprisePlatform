...
public class GetDemoDataAzureSecurityOvertimeScoreQueryHandler
    : IQueryHandler<GetAzureSecurityOvertimeScoreQuery, TimeScoreSeries?>
{
    public Task<TimeScoreSeries?> Handle(GetAzureSecurityOvertimeScoreQuery request, CancellationToken cancellationToken)
    {
        int range = 30;
