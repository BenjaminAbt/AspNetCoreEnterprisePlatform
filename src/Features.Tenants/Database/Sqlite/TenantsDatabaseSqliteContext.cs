...
namespace BenjaminAbt.MyDemoPlatform.Features.Tenants.Database.Sqlite;

/// Warning: do not rename this class without edit the CI/CD Pipeline (Migrations!) too!

public class TenantsDatabaseSqliteContext : SqlServerBaseDbContext, ITenantsDbContext
{
    public TenantsDatabaseSqliteContext(DbContextOptions<TenantsDatabaseSqliteContext> options)
        : base(options) { }
